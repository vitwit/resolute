            ...
            <form onSubmit={handleSubmit}>
              ...
              {showMsgFrom && (
                <Box>
                  ...
                  {obj.txType === "redelegate" ? (
                    <ProposalRedelegateForm />
                  ) : null}

                  {obj.txType === "undelegate" ? (
                    <ProposalUndelegateForm
                  ...
                  <Box>
                    {obj?.messages?.map(
                      (m, i) =>
                        ...
                        (m.typeUrl === DELEGATE_MSG && (
                          <DelegateMsgComponent
                            msg={m}
                            index={i}
                            deleteMsg={deleteMsg}
                          />
  ...
  return (
    <Box sx={{ flexGrow: 1 }}>
      ...
      <Grid container spacing={{ xs: 1, md: 1 }} md={12}>
        {proposals?.status === "pending" ? <CircularProgress /> : null}
                ...
                <Grid container>
                    ...
                    <Box sx={{ float: "right" }}>
                      {p?.status === "PROPOSAL_STATUS_SUBMITTED" ? (
                        <Button
                          ...
                          sx={{ float: "right", justifyContent: "right" }}
                        >
                          Vote
                        </Button>
                      ) : null}
                  ...
                  <Grid container>
                    <Grid md={11}>
                      ...
                      <RowItem lable={"Submit Time"} value={p?.submit_time} />
                      <RowItem
                        lable={"Group Version"}
                      ...
                      <RowItem
                        lable={"Vote"}
                        value={JSON.stringify(p?.vote_state, null, 2)}
                      />
                      <Grid container>
                        <Grid md={4}>
                          <Typography

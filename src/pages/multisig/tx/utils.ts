...
export const parseSendMsgsFromContent = (from: string, content: string): [Msg[], string] => {
...
const parseSendTx = (from: string, msg: string): Msg => {
    ...
    if (values.length != 2) {
        throw new Error(`invalid message: expected ${2} values got ${values.length}`);
    }
...
// if provided content is invalid.
export const parseDelegateMsgsFromContent = (delegator: string, content: string): [Msg[], string] => {
    const messages = content.split("\n");
...
// if provided content is invalid.
export const parseUnDelegateMsgsFromContent = (delegator: string, content: string): [Msg[], string] => {
    const messages = content.split("\n");
...
// if provided content is invalid.
export const parseReDelegateMsgsFromContent = (delegator: string, content: string): [Msg[], string] => {
    const messages = content.split("\n");

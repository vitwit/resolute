...
import { Box, Button, Chip, CircularProgress, FormControl, Paper } from '@mui/material'
                                ...
                                <TableBody>
                                    {accounts.map((row) => (
                                        ...
                                        >
                                            ...
                                            <StyledTableCell>
                                                <Chip label={shortenAddress(row?.address, 21)} variant="filled" size="medium" />
                                            </StyledTableCell>
                                            <StyledTableCell>{row?.pubkeyjson?.value?.threshold || 0}</StyledTableCell>
                                            <StyledTableCell>

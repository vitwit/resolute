...
const ReDelegation_Form = ({ chainInfo }) => {
  ...
  return (
    <form onSubmit={(e) => handleSubmit(e, obj)}>
      ...
      >
        <InputLabel id="demo-simple-select-label">Source Validator</InputLabel>
        <Select
          name="fromValidator"
      ...
      >
        <InputLabel id="demo-simple-select-label">To Validator</InputLabel>
        <Select
          name="toValidator"
          labelId="demo-simple-select-label"
          id="demo-simple-select"
          value={toValAddress?.value}
          label="Select Validator"
          onChange={handleChange2}
        >
          {data.map((v, k) => (
...
export default ReDelegation_Form;

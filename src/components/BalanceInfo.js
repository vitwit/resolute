      ...
      <Grid container spacing={3}>
            ...
            <Paper elevation={0} style={{ padding: 12 }}>
              ...
              >
                {(
                  ...
                  parseFloat(props.delegations) +
                  parseFloat(props.rewards) +
                  parseFloat(props.unbonding)
                )
                  .toFixed(5)
                  .toLocaleString()}
                &nbsp;{currency.coinDenom}
        ...
        <Grid item xs={6} md={2}>
          ...
          <Button
            ...
            onClick={() => navigateTo(`/${selectedNetwork}/send`)}
          >
            Send
          </Button>
        </Grid>
        <Grid item xs={6} md={2}>
          ...
          <Button
            ...
            fullWidth
            className="button-capitalize-title"
            onClick={() => navigateTo(`/${selectedNetwork}/staking`)}
          >
            Rewards
          </Button>
        </Grid>
...
BalanceInfo.propTypes = {
  ...
  delegations: PropTypes.oneOfType([PropTypes.number, PropTypes.string])
    .isRequired,
  rewards: PropTypes.oneOfType([PropTypes.number, PropTypes.string]).isRequired,
  unbonding: PropTypes.oneOfType([PropTypes.number, PropTypes.string])
    .isRequired,

            ...
            <Dialog onClose={handleClose} open={open}>
                <form onSubmit={handleSubmit(onSubmit)}>
                    <DialogContent>
                        ...
                        >
                            <b>
                                Staking will lock your funds for {Math.floor(parseInt(params?.params?.unbonding_time) / (3600 * 24))}+ days.
                            </b>
                            <br />
                            You will need to undelegate in order for your staked assets to be liquid again.
                            This process will take {Math.floor(parseInt(params?.params?.unbonding_time) / (3600 * 24))} days to complete.
                        </Alert>

  ...
  return (
    <div className='space-y-10'>
        <div className='network'>
            <Image src="./all-networks-icon.svg" height={32} width={32} alt="all-networks-logo" />
        ...
        <table className='custom-table overflow-y-scroll' >
          ...
          {[1, 2, 3, 4].map((item, index) => (
            <tr key={index} className="">
              <td className="">
                <div className=''>Send 1 ATOM To cosmos1le7vetsh5...6aj5nhf2</div>
              ...
              <Image
                ...
                <Image src="./DeleteRed.svg"  width={40} height={40} alt="Delete-logo"/>
                </div>
              </td>

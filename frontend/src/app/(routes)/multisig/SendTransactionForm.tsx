      ...
      <div className="space-y-6">
        ...
        >
          <div className="w-full space-y-6 relative">
            ...
            <div className="w-full space-y-2">
              <div className="input-bold-label">From</div>
              <div className="relative">
                <input
                  className="input-w-full"
                  {...register("Form-type", {
            ...
            <div className="w-full space-y-2">
              <div className="input-bold-label">Recipient Name</div>
              <div className="relative">
                <input
                  className="input-w-full"
                  {...register("Recipient-Name-type", {
                    required: "Recipient-Name-type is required",
                  })}
                  type="text"

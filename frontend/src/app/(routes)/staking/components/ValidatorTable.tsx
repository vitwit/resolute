        ...
        <tr className="table-border-line">
          <td className="px-0 py-8">
            <div className="mr-auto flex">
              <div className="text-[#ffffffad] text-base font-normal leading-[normal]">
                # {get(value, 'rank', '-')}
              </div>
            </div>
          </td>
          ...
          <td className="">
            <div className="text-[#ffffffad] text-left text-base font-normal leading-[normal]">
              {parseInt(
                (
          ...
          <td className="">
            <div className="text-left text-base font-normal leading-[normal] text-[#ffffffad]">
